...
**the maintainer** ([Reticle Works](https://reticle-works.com)) — design and direction. Built with [Claude](https://claude.com/claude-code) (Anthropic) and [Codex](https://openai.com/index/introducing-codex/) (OpenAI) as development tools under human direction; see [`NOTICE`](NOTICE).
