...
CASES = (
    FixtureCase(
        ...
        version="2.1.229",
        filename="claude-2.1.229-synthetic.jsonl",
        line_count=10,
        event_counts={
            "compaction": 1,
            "final_response": 1,
        ...
        event_digest="73f032b6ef33a0aa9ae136d48470d63edb49b8e5248210f7d42a4a014dc364cb",
    ...
    FixtureCase(
        client=Client.CODEX,
        version="0.149.0",
        filename="codex-0.149.0-synthetic.jsonl",
        line_count=16,
        event_counts={
            "compaction": 1,
            "final_response": 3,
