...
def test_operator_aliases_default_to_you_and_operator_only(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    assert critical_hits("waiting on operator") == [("needs_operator", "waiting on operator")]
