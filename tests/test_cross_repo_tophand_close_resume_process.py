...
FLEET_ROOT = Path(os.environ.get("FLEET_SOURCE_ROOT", "/private/tmp/fleet-final-composition-20260824"))
LANE = "probe-lane"
...
def test_same_session_resume_uses_structured_owner_authenticated_receipt_and_no_duplicate_launch(
    ...
    try:
        ...
        request = {
            "operation": _operation("create_or_resume", "resume-a", token, digest),
            **resume_fields,
        }
        child = _adapter_child(tmp_path, forced)
