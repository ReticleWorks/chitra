...
- **[Concepts — Completion Gating](../concepts.md#goals-and-completion-gating)** — How completion review works in production.
- **[Watchd](watchd.md)** — The production completion-review daemon.
